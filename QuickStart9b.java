...
// setting the color of the new layer to the familiar yellow.
...
public class QuickStart9b extends JFrame {
  ...
  ImageIcon yellcross = new ImageIcon("Icon0915b.jpg");
  ...
  public static void main(String[] args) {
    QuickStart9b qstart = new QuickStart9b();
...
class AttrTab extends JDialog {
  JPanel panel1 = new JPanel();
  com.esri.mo2.map.dpy.Layer layer = QuickStart9b.layer4;
