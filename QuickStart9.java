...
// selections from an existing feature layer.
...
public class QuickStart9 extends JFrame {
  ...
  JMenuItem createlayeritem  = new JMenuItem("create layer from selection",
                    new ImageIcon("Icon0915b.gif"));
  JMenuItem printitem = new JMenuItem("print",new ImageIcon("print.gif"));
  JMenuItem addlyritem = new JMenuItem("add layer",new 
     ImageIcon("addtheme.gif"));
  JMenuItem remlyritem = new JMenuItem("remove layer",new
     ImageIcon("delete.gif"));
  JMenuItem propsitem = new JMenuItem("Legend Editor",new
     ImageIcon("properties.gif"));
  Toc toc = new Toc();
  ...
  public QuickStart9() {
    ...
    layerlis = new ActionListener() {public void
  ...
  public static void main(String[] args) {
    QuickStart9 qstart = new QuickStart9();
...
class AttrTab extends JDialog {
  JPanel panel1 = new JPanel();
  com.esri.mo2.map.dpy.Layer layer = QuickStart9.layer4;
