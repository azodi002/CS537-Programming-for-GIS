...
public class QuickStart9c extends JFrame {
	  ...
	  if (source instanceof JMenuItem) {
		...
		if(arg == "add layer") {
	      ...
	      if (flayer2.hasSelection()) {
	        ...
	        try {    // this oode will automatically select the new layer!!
  ...
  public static void main(String[] args) {
    QuickStart9c qstart = new QuickStart9c();
...
class AttrTab extends JDialog {
  JPanel panel1 = new JPanel();
  com.esri.mo2.map.dpy.Layer layer = QuickStart9c.layer4;
