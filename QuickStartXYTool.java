...
// The csv file MughalEmperors.txt is more complicated than data.csv
// in my in class example,and the lat and long are also wanted in the
// attribute table.  See the createDbfFields() method. In any case, this
// code is designed specifically for Mughal Empire applic, but can be
// adapted for other csv files.
...
//TIPS: two sources of shapefile writing errors were:
  ...
  // 2. column name with all digits and special characters in
           // createDbfFields
  // 3.  field width limit on VARCHAR is 250
